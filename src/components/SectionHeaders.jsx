...
function SectionHeaders({ topHeader, bottomHeader, desc, marginBottom = 4 }) {
  ...
  return (
    <div ref={ref}>
      <h2
        ...
        className={`text-[clamp(20px,7.5vw,60px)] font-bold  bg-clip-text text-transparent bg-clip-gradient text-center transition-all duration-800 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-6 opacity-0"}`}
      >
        {topHeader}
        {bottomHeader && (
          <>
